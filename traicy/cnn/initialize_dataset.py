...
def main():
    ...
    b = get_serialized_file()  # read the TRAICY_data Dataset and serialize a TraicyData class to the file
    b = read_datafile(filename)  # read and deserialize the file
    print(b.train_label, b.eval_label,
          b.test_label)  # print the labels of the three arrays you created to check if they are correct
